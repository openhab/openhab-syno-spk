...
You need Java 11 to be able to run openHAB >= 3.1.0, so please download an applicable JDK for your platform, (for example from https://www.azul.com/downloads/?package=jdk) because Oracle is not offering 32bit compatible package.
