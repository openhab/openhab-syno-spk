...
DOWNLOAD_FILE="distribution-1.5.0-runtime.zip"
DOWNLOAD_PATH="https://github.com/openhab/openhab/releases/download/v1.5.0"
EXTRACTED_FOLDER="OpenHAB-runtime-1.4.0"
