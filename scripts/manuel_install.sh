...
DEST_FOLDER="/volume1/@appstore/openHAB2"

DAEMON_USER="openhab2"
DAEMON_PASS="$(openssl rand 12 -base64 2>nul)"
DAEMON_ID="openHAB2 daemon user"
